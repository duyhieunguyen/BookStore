...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 16, 2019 at 12:55 PM
...
CREATE TABLE IF NOT EXISTS `books` (
  ...
  KEY `FK71btqhk95xu3ktf863l90oqdd` (`publisher_id`)
...
(32, 'Rick Riordan', 'US', 0, 'Ho-so-a-than-Rick-Riordan-214x300.jpg', 100000, 0, 'Percy Jackson Và Các Vị Thần Trên Đỉnh Olympus Phần 4,5: Hồ sơ á thần', NULL, 19, NULL);
...
CREATE TABLE IF NOT EXISTS `password_reset_token` (
  ...
  KEY `FKoyrnx3gaa02g366ipisgjsl0g` (`personid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `role_person` (
  ...
  KEY `FKg008ovnpp41l4fbhqf1mcs1qy` (`roleid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `upload` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK1brmojlpdw5028ifj7r1qxo39` (`book_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
